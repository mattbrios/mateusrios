<?php
    ...
    $to         = 'mattbrios@gmail.com';  // put your email here
    ...
    if ( mail( $to, $subject, $contents, $headers ) ) {
        $result = array( 'response' => 'success', 'message'=>'<strong>Obrigado!</strong>&nbsp; Seu e-mail foi entregue com sucesso.' );
    } else {
        $result = array( 'response' => 'error', 'message'=>'<strong>OPS...</strong>&nbsp; Algo de errado aconteceu...'  );
    }
